...
import { FaCalendar, FaCalendarDay, FaCalendarDays, FaDollarSign } from "react-icons/fa6";
import { IoIosArrowBack, IoIosArrowDropleft, IoIosArrowDropright, IoIosArrowForward } from "react-icons/io";

const FeaturedTatuArtists = () => {
    return (
        <div className="container mx-auto md:my-20">
            <div className="flex justify-between items-center mb-4">
                <h1 className="text-2xl font-bold">Featured Piercing Artists</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 ">
                <div className="border rounded-xl p-2">
                    <Image src={AllImages.image5} alt="image" height={300} width={500}></Image>
                ...
                <div className="border rounded-xl p-2">
                    <Image src={AllImages.image6} alt="image" height={300} width={500}></Image>
                    <div className="flex justify-between items-center my-3">
                        <div className="flex justify-center items-center gap-2">
                            <Image src={AllImages.image6} alt="image" height={50} width={50} className="rounded-full"></Image>
                            <div>
                                <h1 className="text-xl font-semibold">Lora Craft</h1>
                                <p className="text-xs text-neutral-500">New York,USA</p>
                            </div>
                ...
                <div className="border rounded-xl p-2">
                    <Image src={AllImages.image7} alt="image" height={300} width={500}></Image>
                    <div className="flex justify-between items-center my-3">
                        <div className="flex justify-center items-center gap-2">
                            <Image src={AllImages.image7} alt="image" height={50} width={50} className="rounded-full"></Image>
                            <div>
                                <h1 className="text-xl font-semibold">Lora Craft</h1>
                                <p className="text-xs text-neutral-500">New York,USA</p>
                            </div>
                ...
                <div className="border rounded-xl p-2">
                    <Image src={AllImages.image8} alt="image" height={300} width={500}></Image>
                    <div className="flex justify-between items-center my-3">
                        <div className="flex justify-center items-center gap-2">
                            <Image src={AllImages.image8} alt="image" height={50} width={50} className="rounded-full"></Image>
                            <div>
                                <h1 className="text-xl font-semibold">Lora Craft</h1>
                                <p className="text-xs text-neutral-500">New York,USA</p>
                            </div>
...
export default FeaturedTatuArtists;