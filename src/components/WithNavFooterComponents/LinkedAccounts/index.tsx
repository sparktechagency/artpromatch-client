...
const LinkedAccounts = ({ profileData }: { profileData: any }) => {
  const isGoogleConnected = !!profileData?.auth?.isSocialLogin;
  ...
  return (
    <div className="p-5">
      ...
      {isGoogleConnected ? (
        ...
        <div className="border rounded-xl p-5 flex justify-between items-center mb-4 bg-gray-50">
          <div>
