  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#667eea] to-[#764ba2] relative overflow-hidden p-5">
      ...
      <div className="relative z-10 w-full max-w-[500px]">
        <div className={`bg-white/95 backdrop-blur-xl rounded-3xl px-10 py-12 sm:px-6 sm:py-8 shadow-[0_20px_60px_rgba(0,0,0,0.3),inset_0_0_0_1px_rgba(255,255,255,0.1)] ${styles.cardSlideIn}`}>
          {/* Animated Success Icon */}
          <div className="flex justify-center mb-8">
            <div className={`relative w-[120px] h-[120px] sm:w-[100px] sm:h-[100px] bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-full flex items-center justify-center ${styles.iconPop}`}>
              <div className={`absolute inset-0 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-600 ${styles.pulseRing}`}></div>
          ...
          <div className="text-center">
            <h1 className={`text-[32px] sm:text-2xl font-extrabold bg-gradient-to-br from-gray-800 to-gray-600 bg-clip-text text-transparent mb-4 ${styles.slideUp1}`}>
              {message || 'Payment Successful!'}
            </h1>
            <p className={`text-base sm:text-sm text-gray-500 leading-relaxed mb-8 ${styles.slideUp2}`}>
              Thank you for your purchase! Your payment has been processed
              successfully. We're excited to have you on board!
            </p>

            {/* Details Card */}
            <div className={`bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-6 mb-8 ${styles.slideUp3}`}>
...
const SuccessPage = async ({
  ...
  return <SuccessPageContent message={res?.message || 'Payment Successful!'} />;
};
