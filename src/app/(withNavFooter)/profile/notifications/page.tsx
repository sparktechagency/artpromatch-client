    ...
    <div className="p-5">
      <div className="border-0 border-b p-5 flex justify-between items-center mb-4">
        <div>
          ...
          <p className="text-secondary">Turn on all Notifications</p>
        </div>
      ...
      <div className="border-0 border-b p-5 flex justify-between items-center mb-4">
        <div>
          ...
          <p className="text-secondary">
            Get notified when there&apos;s new guest artist in your favourite
            styles coming to work near you
          </p>
        </div>
      ...
      <div>
        ...
        <div className=" flex flex-col md:flex-row justify-between items-center gap-5">
          <Radio value={1}>
            <span className="text-secondary">In App Notification </span>
          </Radio>
          <Radio value={1}>
            <span className="text-secondary">E-mail Notification</span>
          </Radio>
          <Radio value={1}>
            <span className="text-secondary">Text Message Notification </span>
          </Radio>
        </div>
      </div>
